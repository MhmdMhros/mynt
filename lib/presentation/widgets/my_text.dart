...
class MyText extends StatelessWidget {
  ...
  TextStyle _buildStyle(BuildContext context) {
    ...
    return switch (textStyle) {
      TextStyleEnum.poppinsBold => boldyStyle(FontFamilies.poppins),
      TextStyleEnum.poppinsSemiBold => semiBoldStyle(FontFamilies.poppins),
      TextStyleEnum.poppinsMedium => mediumStyle(FontFamilies.poppins),
      TextStyleEnum.poppinsRegualr => regularStyle(FontFamilies.poppins),
      TextStyleEnum.poppinsLight => lightStyle(FontFamilies.poppins),
      TextStyleEnum.latoLight => lightStyle(FontFamilies.lato),
      TextStyleEnum.latoRegualr => regularStyle(FontFamilies.lato),
      TextStyleEnum.latoBold => boldyStyle(FontFamilies.lato),
